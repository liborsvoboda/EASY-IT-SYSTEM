    ...
    <Grid
        ...
        <Grid
            ...
            <ComboBox
                ...
                VerticalAlignment="Center" mah:TextBoxHelper.ClearTextButton="false" mah:TextBoxHelper.IsWaitingForData="True" DisplayMemberPath="ParentName" IsEnabled="true"
                SelectedValuePath="Id" />

            <Label
                x:Name="lbl_description" Grid.Row="3" Grid.Column="0" HorizontalAlignment="Right" HorizontalContentAlignment="Right" />
            <TextBox
                x:Name="txt_description" Grid.Row="3" Grid.Column="1" Margin="0,2,0,2" mah:TextBoxHelper.ClearTextButton="True"
